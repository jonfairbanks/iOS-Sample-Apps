...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    ABCFirstViewController *firstVC = [[ABCFirstViewController alloc] initWithNibName:@"ABCFirstViewController" bundle:nil];
    
    ABCSecondViewController *secondVC = [[ABCSecondViewController alloc] initWithNibName:@"ABCSecondViewController" bundle:nil];
    
    ABCThirdViewController *thirdVC = [[ABCThirdViewController alloc] initWithNibName:@"ABCThirdViewController" bundle:nil];
    
    UITabBarController *tabBarController = [[UITabBarController alloc] init];
    
    [tabBarController setViewControllers:@[firstVC, secondVC, thirdVC]];
